          ...
          <div className="space-y-10 animate-slide-up animate-delay-300">
            <div>
              ...
              <div className="space-y-6 text-muted-foreground leading-relaxed typography-heading-chinese">
                <p className="text-lg">
                    我想問的是，來自台灣的我，在談論「大陸」時，我究竟在談論什麼？是那些隔著海峽眺望到的經濟增長，是那些在新聞標題裡加粗放大的科技突破嗎？四年前，我帶著一個台灣人特有的，既熟悉又陌生的複雜凝視，踏上了這片土地。
                </p>
                <p className="text-lg">
                    我很快就有了答案：都不是。一個時代、一個社會真正的肌理，你無法從遠處的宏大敘事中捕捉。你必須走進去，放下預設，用你自己的眼睛去看，用你自己的耳朵去聽。
                    你得親眼看看成都小巷裡那位糧油店奶奶，你得親耳聽聽重慶白象居里的那位母亲，只有这样你才會明白，這片土地，從來不是一個抽象的概念，而是由千千萬萬個具體的、有溫度、有掙扎、有歡笑的他和她所構成。
                </p>
                <p className="text-lg">
